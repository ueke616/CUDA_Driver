...
objdir    := objs
stdcpp    := c++11
cuda_home := /data/text2_3/miniconda3/envs/trtlearn/lib/python3.8/site-packages/trtpy/trt8cuda115cudnn8
syslib    := /data/text2_3/miniconda3/envs/trtlearn/lib/python3.8/site-packages/trtpy/lib
cuda_arch := 
...
library_paths := $(cuda_home)/lib64 $(syslib)
