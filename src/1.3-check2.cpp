...
#define checkDriver(op) __check_cuda_driver2((op), #op, __FILE__, __LINE__)

bool __check_cuda_driver2(CUresult code, const char* op, const char* file, int line){
...
int main3() {
    // 检查cuda driver的初始化
    // 实际调用的的是__check_cuda_driver这个函数
